...
import br.com.alura.comex.relatorios.RelatorioClientesFieis.ClientesFieis;

class RelatorioClientesFieisTest {

	List<Pedido> pedidos = new ArrayList<>();
	
	RelatorioClientesFieis relatorio = new RelatorioClientesFieis();
	...
	void geracaoDeRelatorioComUmUnicoPedido() {
		...
		List<ClientesFieis> resultado = relatorio.getClientesFieis();
